...
export function scenarioEnd({ tests = [], hooks = [] }): WDIOReporter.Suite {
    return Object.assign(suite('scenario'), {
        _duration: 1451,
...
export function hookEnd(): WDIOReporter.Hook {
    return Object.assign(hook(), {
        _duration: 4,
        errors: [],
        end: '2019-07-22T12:21:36.250Z'
...
export function testFail(): WDIOReporter.Test {
    return Object.assign(test(), {
        _duration: 10,
        errors: [error],
        error: error,
...
export function testSkipped(): WDIOReporter.Test {
    return Object.assign(test(), {
        state: 'skipped'
    })
}

export function testPass(): WDIOReporter.Test {
    return Object.assign(test(), {
        _duration: 1433,
        state: 'passed',
        end: '2019-07-22T12:21:37.684Z'
